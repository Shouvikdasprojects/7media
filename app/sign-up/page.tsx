...
export const metadata = {
  title: 'Sign Up | 7MEDIA',
  description: 'Create a free 7MEDIA account to track your anime, build watchlists, and sync your favorite movies and series.',
}
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="relative flex-1 flex items-center justify-center px-4 py-28 md:py-32">
        ...
        <div className="pointer-events-none absolute -top-24 left-1/2 -translate-x-1/2 h-96 w-96 rounded-full bg-primary/20 blur-[120px]" />
        <div className="pointer-events-none absolute bottom-0 left-1/4 h-72 w-72 rounded-full bg-accent/10 blur-[100px]" />
          ...
          <div className="rounded-3xl border border-border/80 bg-card/90 p-6 md:p-8 shadow-2xl backdrop-blur-xl">
            ...
            <div className="text-center mb-7">
              ...
              <p className="mt-1.5 text-xs md:text-sm text-muted-foreground">
                Join 7MEDIA to create custom watchlists and track movies, TV &amp; anime.
              </p>
            </div>
